...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_pendamping'); ?>
		<?php echo $form->textField($model,'id_pendamping',array('size'=>60,'maxlength'=>255)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'id_penerbangan'); ?>
		<?php echo $form->textField($model,'id_penerbangan'); ?>
	</div>
