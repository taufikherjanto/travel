...
<div class="col-md-6 col-sm-6 col-xs-12">
	<div class="wrap">
		<div class="image-product">
			<?php
			echo CHtml::link(CHtml::image(Yii::app()->baseUrl."/images/dauroh/".$data->gambar,'alt',array("width"=>"200px", "height"=>"200px")), array('/dauroh/detail', 'title_slug'=>$data->title_slug));
			?>
