...
/**
 * This is the model class for table "umroh".
 *
 * The followings are the available columns in table 'umroh':
 * @property integer $id
 * @property integer $id_kategori
 * @property string $judul
 * @property string $title_slug
 * @property string $desc
 * @property string $id_pendamping
 * @property integer $id_penerbangan
...
{	
	...
	public function rules()
	{
		...
		return array(
			array('desc, id_penerbangan', 'required'),
			array('id_kategori, id_penerbangan, quota, quota_active, status_publish', 'numerical', 'integerOnly'=>true),
			array('gambar', 'required', 'on'=>'create'),
			array('judul, title_slug, id_pendamping, jumlah_hari, harga, gambar, tanggal_post, viewer', 'length', 'max'=>255),
			array('tanggal', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_kategori, judul, title_slug, desc, id_pendamping, id_penerbangan, jumlah_hari, tanggal, harga, quota, quota_active, gambar, tanggal_post, status_publish, viewer', 'safe', 'on'=>'search'),
	 ...
	 * @return Umroh the static model class
	 */
