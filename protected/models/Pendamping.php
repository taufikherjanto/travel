 ...
 * @property integer $id
 * @property string $nama_pendamping
...
class Pendamping extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('desc', 'required'),
			array('nama_pendamping', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nama_pendamping, desc', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nama_pendamping',$this->nama_pendamping,true);
