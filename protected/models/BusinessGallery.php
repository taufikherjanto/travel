 ...
 *
 * The followings are the available columns in table 'business_gallery':
 * @property integer $id
 * @property string $gambar
 * @property integer $gambar_id
 */
class BusinessGallery extends CActiveRecord
{
	/**
	 ...
	 * @return BusinessGallery the static model class
	 */
