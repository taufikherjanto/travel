			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12" style="margin-top:15px;">
						<? $this->renderPartial('_menu', array('active' => 'pesanan')); ?>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12">
								...
								<table class="table table-responsive">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo CHtml::link('<span class="glyphicon glyphicon-search" aria-hidden="true"></span> Detail', array('/transaksi/thanks', 'id'=>$data->id), array('target'=>'_blank')); ?></td>
										</tr>
										<?php
											}
										}
