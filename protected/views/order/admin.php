						...
						<div class="content">
							<div class="panel panel-default">
								<div class="panel-heading">
									<?php echo CHtml::link("&laquo; Kembali", array('/user/dashboard'));?> | Pesanan | <?php echo CHtml::link('Waiting Verifikasi', array('/order/waiting'));?> | <?php echo CHtml::link('DP Lunas', array('/order/dp_lunas'));?> | <?php echo CHtml::link('Waiting Verifikasi Pelunasan DP', array('/order/waiting_pelunasan_dp'));?> | <?php echo CHtml::link('Pembayaran Lunas', array('/order/done'));?>
								</div>
