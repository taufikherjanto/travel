                ...
                <div class="col-md-12 product-price1">
                    <div class="col-md-8 single-top">   
                        <div class="flexslider">
                            <ul class="slides">
                                <li data-thumb="<?php echo Yii::app()->request->baseUrl ?>/images/umroh/<?php echo $item->gambar; ?>">
                                    <img src="<?php echo Yii::app()->request->baseUrl ?>/images/umroh/<?php echo $item->gambar; ?>" />
                                </li>
                                <?php 
                                    $idnya = $item->id;
                                    $fotox = Yii::app()->db
