...
class BusinessgalleryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BusinessGallery']))
		{
			$model->attributes=$_POST['BusinessGallery'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('BusinessGallery');
	...
	{
		$model=new BusinessGallery('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BusinessGallery']))
			$model->attributes=$_GET['BusinessGallery'];
	...
	{
		$model=BusinessGallery::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param BusinessGallery $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='business-gallery-form')
		{
